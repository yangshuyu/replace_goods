...
function (_React$Component) {
  ...
  function Table(props) {
    ...
    _this.onRow = function (record, index) {
      ...
      return (0, _extends4["default"])({}, custom, {
        prefixCls: prefixCls,
        store: _this.store,
    ...
    _this.handleFilter = function (column, nextFilters) {
      ...
      var filters = (0, _extends4["default"])({}, _this.state.filters, (0, _defineProperty2["default"])({}, _this.getColumnKey(column), nextFilters)); // Remove filters not in current columns
      ...
      _this.setState(newState, function () {
        ...
        if (onChange) {
          onChange.apply(null, _this.prepareParamsArguments((0, _extends4["default"])({}, _this.state, {
            selectionDirty: false,
            filters: filters,
            pagination: pagination
          })));
    ...
    _this.renderSelectionBox = function (type) {
      return function (_, record, index) {
        ...
        }, React.createElement(_SelectionBox["default"], (0, _extends4["default"])({
          type: type,
          store: _this.store,
          rowIndex: rowKey,
    ...
    _this.getPopupContainer = function () {
      return ReactDOM.findDOMNode((0, _assertThisInitialized2["default"])((0, _assertThisInitialized2["default"])(_this)));
    };
    ...
    _this.renderTable = function (contextLocale, loading) {
      ...
      var locale = (0, _extends4["default"])({}, contextLocale, _this.props.locale);
      ...
      var classString = (0, _classnames["default"])((_classNames = {}, (0, _defineProperty2["default"])(_classNames, "".concat(prefixCls, "-").concat(_this.props.size), true), (0, _defineProperty2["default"])(_classNames, "".concat(prefixCls, "-bordered"), _this.props.bordered), (0, _defineProperty2["default"])(_classNames, "".concat(prefixCls, "-empty"), !data.length), (0, _defineProperty2["default"])(_classNames, "".concat(prefixCls, "-without-column-header"), !showHeader), _classNames));
      ...
      return React.createElement(_rcTable["default"], (0, _extends4["default"])({
        key: "table"
      }, restProps, {
        onRow: _this.onRow,
    ...
    _this.state = (0, _extends4["default"])({}, _this.getDefaultSortOrder(_this.columns), {
      // 减少状态
  ...
  (0, _createClass2["default"])(Table, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      if ('pagination' in nextProps || 'pagination' in this.props) {
        this.setState(function (previousState) {
          var newPagination = (0, _extends4["default"])({}, defaultPagination, previousState.pagination, nextProps.pagination);
      ...
      if (filteredValueColumns.length > 0) {
        ...
        var newFilters = (0, _extends4["default"])({}, this.state.filters);
    ...
    value: function toggleSortOrder(column) {
      ...
      var oldSortOrder = this.isSameColumn(sortColumn, column) ? sortOrder : undefined; // 切换排序状态，按照降序/升序/不排序的顺序
      ...
      if (onChange) {
        onChange.apply(null, this.prepareParamsArguments((0, _extends4["default"])({}, this.state, newState)));
      }
    }
  }, {
    ...
    value: function renderColumnsDropdown(columns, locale) {
      ...
      return (0, _util.treeMap)(columns, function (column, i) {
        ...
        if (column.sorter) {
          ...
          onHeaderCell = function onHeaderCell(col) {
            ...
            if (column.onHeaderCell) {
              colProps = (0, _extends4["default"])({}, column.onHeaderCell(col));
            } // Add sorter logic
        ...
        return (0, _extends4["default"])({}, column, {
          className: (0, _classnames["default"])(column.className, (_classNames3 = {}, (0, _defineProperty2["default"])(_classNames3, "".concat(prefixCls, "-column-has-actions"), sortButton || filterDropdown), (0, _defineProperty2["default"])(_classNames3, "".concat(prefixCls, "-column-has-filters"), filterDropdown), (0, _defineProperty2["default"])(_classNames3, "".concat(prefixCls, "-column-has-sorters"), sortButton), (0, _defineProperty2["default"])(_classNames3, "".concat(prefixCls, "-column-sort"), isSortColumn && sortOrder), _classNames3)),
    ...
    value: function renderPagination(paginationPosition) {
      ...
      return total > 0 && (position === paginationPosition || position === 'both') ? React.createElement(_pagination["default"], (0, _extends4["default"])({
    ...
    value: function prepareParamsArguments(state) {
      var pagination = (0, _extends4["default"])({}, state.pagination); // remove useless handle function in Table.onChange
    ...
    value: function recursiveSort(data, sorterFn) {
      ...
      return data.sort(sorterFn).map(function (item) {
        return item[childrenColumnName] ? (0, _extends4["default"])({}, item, (0, _defineProperty2["default"])({}, childrenColumnName, _this9.recursiveSort(item[childrenColumnName], sorterFn))) : item;
      });
    }
  }, {
    key: "getLocalData",
    ...
    value: function createComponents() {
      ...
      this.components = (0, _extends4["default"])({}, components, {
        body: (0, _extends4["default"])({}, components.body, {
          row: this.row
        })
      });
    }
    ...
    value: function render() {
      ...
      return React.createElement("div", {
        ...
        style: style
      }, React.createElement(_spin["default"], (0, _extends4["default"])({}, loading, {
