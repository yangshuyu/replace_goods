...
var Thumb = function (_Component) {
  ...
  function Thumb() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3['default'])(this, (_ref = Thumb.__proto__ || Object.getPrototypeOf(Thumb)).call.apply(_ref, [this].concat(args))), _this), _this.getDefaultThumb = function () {
      var children = [];
  ...
  (0, _createClass3['default'])(Thumb, [{
    ...
    value: function render() {
      ...
      var props = (0, _extends3['default'])({}, this.props, this.props.componentProps);
